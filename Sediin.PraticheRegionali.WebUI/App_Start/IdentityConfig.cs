...
namespace Sediin.PraticheRegionali.WebUI
{
    ...
    {
        /// <summary>
        /// Admin - amministratore del portale
        /// Dipendente - inserisce pratiche per se stesso
        ...
        public enum Roles
        {
            Admin,
            Super, // Super Admin
            Azienda,//inserisce pratiche per se stesso
            Dipendente, //inserisce pratiche per se stesso
            Sp_CAF,//inserisce pratiche per dipendenti
            Sp_Consulente, //inserisce pratiche per azienda
            Sp_Sindacale,//inserisce pratiche per azienda e dipendenti
    ...
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            controller.SendMailAsync(new SimpleMailMessage
            {
                ToName = message.Destination,
    ...
    // Configurare la gestione dei Ruoli in questa applicazione.
